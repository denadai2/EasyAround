...
\label{fig:inference}
\end{figure}
%TODO: requirements deve diventare request
...
\end{figure}
%TODO: nel domain Client.Name dovrebbe essere Client.name. Togliere la chiave esterna a preferences e contraints. Location.lng, non long. creare Day.ID per semplicità
